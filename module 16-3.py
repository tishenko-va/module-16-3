...
async def post_user(username: Annotated[str, Path(min_length=5, max_length=20, description='Enter username', example='Valery')],
...
async def update_user(user_id: int,
                      username: Annotated[str, Path(min_length=5, max_length=20, description='Enter username', example='Valery')],
                      age: int = Path(ge=18, le=120, description="Enter age", example='55'))-> dict:
